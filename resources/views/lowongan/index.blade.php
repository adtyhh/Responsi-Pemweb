            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="flex justify-end mb-4">
                        <a href="{{ route('lowongan.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                            Tambah Lowongan
                        </a>
                    </div>
                                ...
                                @forelse ($lowongans as $lowongan)
                                    <tr>
                                        ...
                                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm flex space-x-2">
                                            <a href="{{ route('lowongan.show', $lowongan->id) }}" class="text-indigo-600 hover:text-indigo-900">Lihat</a>
                                            <a href="{{ route('lowongan.edit', $lowongan->id) }}" class="text-green-600 hover:text-green-900">Edit</a>
